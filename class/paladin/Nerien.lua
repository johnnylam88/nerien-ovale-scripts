...
Define(guardian_of_ancient_kings_holy 86669)
	SpellInfo(guardian_of_ancient_kings_holy cd=180)
Define(guardian_of_ancient_kings_protection 86659)
	SpellInfo(guardian_of_ancient_kings_protection cd=180)
Define(guardian_of_ancient_kings_retribution 86698)
	SpellInfo(guardian_of_ancient_kings_retribution cd=180)
