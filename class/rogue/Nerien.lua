...
Define(ambush 8676)
	SpellInfo(ambush buff_combo=shadow_blades combo=2)
...
Define(crimson_tempest 121411)
	SpellInfo(crimson_tempest combo=0)
...
Define(deadly_throw 26679)
	SpellInfo(deadly_throw combo=0 duration=6)
...
Define(expose_armor 8647)
	SpellInfo(expose_armor buff_combo=shadow_blades combo=1)
	SpellAddTargetDebuff(expose_armor weakened_armor=1)
Define(fan_of_knives 51723)
	SpellInfo(fan_of_knives buff_combo=shadow_blades combo=1)
Define(feint 1966)
	SpellInfo(feint duration=5)
...
Define(garrote 703)
	SpellInfo(garrote buff_combo=shadow_blades combo=1 duration=18)
...
Define(gouge 1776)
	SpellInfo(gouge cd=10 duration=4)
	SpellAddTargetDebuff(gouge gouge=1)
Define(hemorrhage 16511)
	SpellInfo(hemorrhage buff_combo=shadow_blades combo=1)
...
Define(kidney_shot 408)
	SpellInfo(kidney_shot cd=20 combo=0)
...
Define(mutilate 1329)
	SpellInfo(mutilate buff_combo=shadow_blades combo=2)
...
Define(revealing_strike 84617)
	SpellInfo(revealing_strike buff_combo=shadow_blades combo=1 duration=24 tick=3)
	SpellAddTargetDebuff(revealing_strike revealing_strike=1)
Define(rupture 1943)
	SpellInfo(rupture combo=0)
...
Define(shadowstep 36554)
	SpellInfo(shadowstep cd=20 duration=2)
...
Define(shuriken_toss 114014)
	SpellInfo(shuriken_toss combo=1)
Define(shuriken_toss_talent 16)
Define(sinister_strike 1752)
	SpellInfo(sinister_strike buff_combo=shadow_blades combo=1)
Define(slice_and_dice 5171)
	SpellInfo(slice_and_dice combo=0)
...
Define(tricks_of_the_trade 57934)
	SpellInfo(tricks_of_the_trade cd=30 duration=20)
