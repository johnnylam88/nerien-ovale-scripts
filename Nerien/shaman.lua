...
Define(earth_shield 974)
	...
	SpellAddBuff(earth_shield lightning_shield=0 water_shield=0)
Define(earth_shock 8042)
	SpellInfo(earth_shock cd=6 sharedcd=shock)
	SpellInfo(earth_shock addcd=-1 if_mastery=1)
...
Define(earthliving 51945)
	SpellInfo(earthliving duration=12 tick=3)
...
Define(elemental_mastery 16166)
	SpellInfo(elemental_mastery cd=120 duration=20)
...
Define(flame_shock 8050)
	SpellInfo(flame_shock cd=6 duration=24 sharedcd=shock tick=3)
	SpellInfo(flame_shock addcd=-1 if_mastery=1)
	SpellInfo(flame_shock addduration=6 glyph=glyph_of_flame_shock)
...
Define(glyph_of_flame_shock 55447)
...
Define(healing_rain 73920)
	SpellInfo(healing_rain cd=10 duration=10 tick=2)
...
Define(lightning_shield 324)
	...
	SpellAddBuff(lightning_shield earth_shield=0 lightning_shield=1 water_shield=0)
...
Define(riptide 61295)
	SpellInfo(riptide cd=6 duration=18 tick=3)
...
Define(spirit_walk 58875)
	SpellInfo(spirit_walk cd=120 duration=15)
	SpellInfo(spirit_walk addcd=-30 glyph=glyph_of_spirit_walk)
...
Define(water_shield 52127)
	...
	SpellAddBuff(water_shield earth_shield=0 lightning_shield=0 water_shield=1)
