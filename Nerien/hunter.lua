...
Define(scare_beast 1513)
	SpellInfo(scare_beast duration=20 focus=25)
...
Define(tranquilizing_shot 19801)
	...
	SpellInfo(tranquilizing_shot cd=10 focus=0 glyph=glyph_of_tranquilizing_shot)
...
Define(widow_venom 82654)
	SpellInfo(widow_venom duration=30 focus=15)
