...
Define(bloodthirst 23881)
	...
	SpellRequire(bloodthirst rage add=-2 enabled=(Talent(seethe_talent) and not BuffPresent(recklessness)))
	SpellRequire(bloodthirst rage add=-8 enabled=(not Talent(seethe_talent) and BuffPresent(recklessness)))
	SpellRequire(bloodthirst rage add=-12 enabled=(Talent(seethe_talent) and BuffPresent(recklessness)))
...
Define(ignore_pain 190456)
	SpellInfo(ignore_pain cd=12 gcd=0 offgcd=1 rage=60 duration=12)
